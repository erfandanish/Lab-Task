...
mysqli_free_result($result);
	...
	echo '<p class="error"> If no record is shown, this is because you had an incorrect missing entry in search form.<br>Click the back button on the browser and try again.</p>';
