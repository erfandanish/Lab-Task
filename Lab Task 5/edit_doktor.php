...
if(mysqli_num_rows($result) == 0) {
	$q = "UPDATE doktor SET FirstName='$n', LastName = '$I',  Specialization = '$s', Password ='p' WHERE ID='$id' LIMIT 1";
...
echo '<p class="error">The no ic has already been registered</p>';
		...
		echo '<p class="error"> The following error (s) occurred: <br/>'; foreach ($error as $msg)
		{	
		echo " -$msg<br/> \n";
	}	
...
if (mysqli_num_rows($result) == 1) {
	...
	$row = mysqli_fetch_array ($result, MYSQLI_NUM); //create the form
	//create the form
